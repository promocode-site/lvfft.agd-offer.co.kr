...
export default function DiscountCodes() {
  const schema = {
    ...
    "@type": "ItemList",
    name: "파페치 할인코드 총정리",
    description: "2026년 4월 기준 파페치에서 사용 가능한 모든 할인코드와 프로모션 코드 목록",
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative page-container py-12 md:py-20">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            2026년 4월 기준, 파페치에서 사용할 수 있는 모든 할인코드의 상세 조건, 적용 방법, 유의사항을 한 곳에서 확인하세요.
          </p>
        </div>
      </section>
      ...
      {/* Coupon Cards */}
      <section className="page-container">
        <h2 className="section-title gold-text">🎟️ 2026년 4월 할인코드 상세 정보</h2>
