  ...
  return (
    <>
      <PageMeta
        ...
        description="2026년 7월 최신 파페치(Farfetch) 할인쿠폰 및 할인코드 총정리. 프로모션 코드, 시즌 세일, 최대 할인 정보를 한 곳에서 확인하세요."
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative page-container py-16 md:py-24">
          <div className="max-w-2xl">
            <p className="text-primary text-sm font-semibold tracking-wider mb-3">2026년 7월 최신 업데이트</p>
      ...
      <section className="page-container">
        ...
        <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
          2026년 7월 기준, 파페치에서 사용할 수 있는 모든 할인코드를 한눈에 확인하고 바로 적용하세요.
        </p>
